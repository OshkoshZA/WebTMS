...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: '/supplier-invoices', name: 'supplier-invoices-list', component: () => import('../views/SupplierInvoicesListView.vue') },
    { path: '/supplier-invoices/new', name: 'supplier-invoices-new', component: () => import('../views/SupplierInvoiceCreateView.vue') },
    { path: '/supplier-invoices/:id', name: 'supplier-invoices-detail', component: () => import('../views/SupplierInvoiceDetailView.vue'), props: true },
