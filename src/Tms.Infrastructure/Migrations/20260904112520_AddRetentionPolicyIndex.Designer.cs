...
namespace Tms.Infrastructure.Migrations
{
    ...
    [Migration("20260904112520_AddRetentionPolicyIndex")]
    partial class AddRetentionPolicyIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tms.Modules.Debrief.Debrief", b =>
                {
                    ...
                    b.Property<string>("ExceptionReasons")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Tms.Modules.Privacy.RetentionPolicy", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "DataCategory")
                        .IsUnique()
            ...
            modelBuilder.Entity("Tms.Modules.Rating.ExchangeRate", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "FromCurrencyId", "ToCurrencyId", "EffectiveDate")
                        .IsUnique()
            ...
            modelBuilder.Entity("Tms.Modules.Billing.CreditNoteLine", b =>
                {
                    b.HasOne("Tms.Modules.Billing.CreditNote", null)
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("Tms.Modules.Debrief.DebriefExpense", b =>
                {
                    b.HasOne("Tms.Modules.Debrief.Debrief", null)
                        .WithMany("Expenses")
