        ...
        return Document.Create(container =>
        {
            container.Page(page =>
            {
                ...
                page.Header().Column(col =>
                {
                    ...
                    col.Item().PaddingTop(10).Text("TAX INVOICE").FontSize(14).Bold();
                });
        ...
        return Document.Create(container =>
        {
            container.Page(page =>
            {
                ...
                page.Header().Column(col =>
                {
                    ...
                    col.Item().Text($"Reg. {company.RegistrationNo} · VAT {company.VatNumber}");
                    col.Item().Text(company.PhysicalAddress);
                    col.Item().PaddingTop(10).Text("CREDIT NOTE").FontSize(14).Bold();
                });
        ...
        return Document.Create(container =>
        {
            container.Page(page =>
            {
                ...
                page.Header().Column(col =>
                {
                    ...
                    col.Item().Text($"Reg. {company.RegistrationNo} · VAT {company.VatNumber}");
                    col.Item().Text(company.PhysicalAddress);
                    col.Item().PaddingTop(10).Text("LOAD CONFIRMATION").FontSize(14).Bold();
                });
